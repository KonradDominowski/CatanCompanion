...
model_path = './model_ncnn_model'
img_source = './images/test_may_2.jpg'
min_thresh = 0
user_res = '1600x1600'
...
while True:
    ...
    cv2.imwrite('./test' + os.sep + 'ncnn' + '.jpg', frame)

    # If inferencing on individual images, wait for user keypress before moving to next image. Otherwise,
